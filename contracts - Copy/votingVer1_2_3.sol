 ...
 */
 ...
 contract votingVer1_2_3
 {
    ...
    event LOGroomClosed(uint indexed id, uint yes, uint no, bool stt);
            ...
            roomOpening(_id) public returns (bool)
    {
        ...
        LOGroomClosed(rooms[_id].id, getCountOf(_id, rooms[_id].options[0]), getCountOf(_id, rooms[_id].options[1]), true);
        return true;
    }
